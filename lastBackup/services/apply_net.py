...
from api.detectron2.config import CfgNode, get_cfg
from api.detectron2.data.detection_utils import read_image
from api.detectron2.engine.defaults import DefaultPredictor
from api.detectron2.structures.instances import Instances
from api.detectron2.utils.logger import setup_logger

from api.densepose import add_densepose_config
from api.densepose.structures import DensePoseChartPredictorOutput, DensePoseEmbeddingPredictorOutput
from api.densepose.utils.logger import verbosity_to_level
from api.densepose.vis.base import CompoundVisualizer
from api.densepose.vis.bounding_box import ScoredBoundingBoxVisualizer
from api.densepose.vis.densepose_outputs_vertex import (
    DensePoseOutputsTextureVisualizer,
    DensePoseOutputsVertexVisualizer,
    get_texture_atlases,
)
from api.densepose.vis.densepose_results import (
    DensePoseResultsContourVisualizer,
    DensePoseResultsFineSegmentationVisualizer,
    DensePoseResultsUVisualizer,
    DensePoseResultsVVisualizer,
)
from api.densepose.vis.densepose_results_textures import (
    DensePoseResultsVisualizerWithTexture,
    get_texture_atlas,
)
from api.densepose.vis.extractor import (
    CompoundExtractor,
