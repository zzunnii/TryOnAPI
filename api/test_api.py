...
def main():
    ...
    parser.add_argument("--person", type=str, default=r"C:\Users\tjdwn\OneDrive\Desktop\test.jpg", help="사용자 이미지 파일 경로")
    parser.add_argument("--clothing", type=str, default=r"C:\Users\tjdwn\OneDrive\Desktop\parsingData\data\1.Training\original\Item-Image\1008094_F.jpg", help="의류 이미지 파일 경로")
    parser.add_argument("--category", type=str, default="lower", choices=["upper", "lower", "dress", "outer"], help="의류 카테고리")
